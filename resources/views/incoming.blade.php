...
<body>
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" href="{{url('incoming_post')}}">Add incoming post</a>
        </li>
        <li class="nav-item">
    ...
    <div style="margin:10px auto 0 auto;text-align:center;padding:10px;color:#000;background-color:#ddffdd;border:1px solid #ccc">
        <h3>Success!</h3>
        <p style="margin:0">{{ Session::get('message') }}</p>
    </div>
    @endif
    <div class="container mt-5" style="width:70%;margin:0 auto;">
    <h3 style="color:green;margin:0 0 50px 0;">Add incoming post</h3>
    <form action="{{url('incoming_post/add')}}" method="POST">
    {{ csrf_field() }}
    <div class="form-row">
        <div class="form-group col-md-4">
            <label for="fname">Date of receipt:</label><br>
        ...
        <div class="form-group col-md-4">
            <label for="fname">Sender's name:</label><br>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <select class="custom-select custom-select-sm mb-3" id="country" name="lname" style="border-color: black;">
            @php
            $country = '';
        ...
        <input type="submit" class="btn btn-danger" value="Add incoming letter">
    </form>
    </div>
