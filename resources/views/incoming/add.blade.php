    ...
    <div class="flex min-h-full flex-col justify-center">
        <div class="sm:mx-auto sm:w-full">
            <nav class="bg-gray-800">
                        ...
                        <div class="flex items-center">
                            <div class="md:block">
                                <div class="ml-1 flex items-baseline space-x-4">
                                    <a href="../incoming/add" class="rounded-md bg-gray-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Add incoming post</a>
                ...
                <div class="min-[921px]:hidden" id="mobile-menu">
                    ...
                    @endif
                        ...
                        <a href="../incoming/add" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Add incoming post</a>
            ...
            <main>
                ...
                @endif
            <form action="{{url('incoming/store')}}" method="POST">
            {{ csrf_field() }}
                ...
                <div class="flex flex-col justify-center">
                    <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                        <header class="px-5 py-5 border-b border-gray-100">
                            <h1 class="font-semibold text-indigo-600">Add incoming post</h1>
                        </header>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 px-5 py-5">
                        ...
                        <label for="sender" class="block text-sm/6 font-medium text-gray-900">Sender's name:</label>
                            <div class="mt-2">
                                <input id="sender" name="sender" type="text" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
