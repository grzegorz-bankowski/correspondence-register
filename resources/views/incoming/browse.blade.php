                ...
                <div class="flex flex-col justify-center">
                    <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                        <header class="px-5 py-4 border-b border-gray-100">
                            <h1 class="font-semibold text-indigo-600">Browse incoming letters</h1>
                        </header>
                        <div class="p-3">
                                ...
                                <table class="table-auto w-full">
                                    <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center">Date of receipt</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center">Letter number</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center">Sender's name</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center">Sender's address</div>
                                            </th>
                                        @if (Auth()->user()->admin == 'yes')
                                            <th class="p-2 whitespace-nowrap">
                                    ...
                                    @foreach($letters as $letter)
                                        <tr>
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-lg text-center">{{ $letter->sender }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                        ...
                                        @if (Auth()->user()->admin == 'yes')
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="text-center px-2 py-2">
                                                    <a href="/incoming/edit/{{ $letter->id }}" class="rounded-md px-2 py-1 text-base font-normal text-white bg-orange-500 hover:bg-orange-700">Edit</a>
                                                </div>
                                                </form>
                                                <form action="/incoming/delete/{{ $letter->id }}" method="post">
                                                    @csrf
                                                    {{ method_field('delete') }}
                                                    <div class="text-center px-2 py-2">
