        ...
        <div class="sm:mx-auto sm:w-full">
            <nav class="bg-gray-800">
                        ...
                        <div class="flex items-center">
                            <div class="hidden md:block">
                                <div class="ml-1 flex items-baseline space-x-4">
                                    ...
                                    <a href="../outgoing/add" class="rounded-md bg-gray-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Add outgoing post</a>
                ...
                <div class="min-[921px]:hidden" id="mobile-menu">
                    ...
                    @endif
                        ...
                        <a href="../outgoing/add" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Add outgoing post</a>
            ...
            <main>
                ...
                <div class="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3" role="alert">
                    <p class="font-bold">All went well!</p>
                    <p class="text-sm">{{ Session::get('message') }}</p>
                    </div>
                @endif
            <section class="antialiased bg-gray-100 text-gray-600 px-4 pt-10 pb-10">
                <form action="{{url('outgoing/store')}}" method="POST">
                {{ csrf_field() }}
                    <div class="flex flex-col justify-center">
                        <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                            <header class="px-5 py-5 border-b border-gray-100">
                                <h1 class="font-semibold text-indigo-600">Add outgoing post</h1>
                            </header>
                            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 px-5 py-5">

                                <div class="sm:col-span-2">
                                <label for="date" class="block text-sm/6 font-medium text-gray-900">Date of dispatch:</label>
                                    <div class="mt-2">
                                        <input type="date" name="date" id="date" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                    @if ($errors->has('date'))
                                ...
                                <div class="sm:col-span-2">
                                <label for="recipient" class="block text-sm/6 font-medium text-gray-900">Recipient's name:</label>
                                    <div class="mt-2">
                                        <input id="recipient" name="recipient" type="text" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                    @if ($errors->has('recipient'))
                                        <span class="error" style="color:red">{{ $errors->first('recipient') }}</span>
                                    @endif
                                </div>
                                ...
                                <label for="street" class="block text-sm/6 font-medium text-gray-900">Street adress:</label>
                                    <div class="mt-2">
                                        <input id="street" name="street" type="text" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                ...
                                <label for="city" class="block text-sm/6 font-medium text-gray-900">City:</label>
                                    <div class="mt-2">
                                        <input id="city" name="city" type="text" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                    @if ($errors->has('city'))
                                ...
                                <label for="code" class="block text-sm/6 font-medium text-gray-900">Postal code</label>
                                    <div class="mt-2">
                                        <input type="text" name="code" id="code" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                    </div>
                                    @if ($errors->has('code'))
                            ...
                            <div class="mt-6 flex items-center justify-center gap-x-6 pb-6">
                                <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add letter</button>
                            </div>
                        </div>
                    </div>
                </form>
